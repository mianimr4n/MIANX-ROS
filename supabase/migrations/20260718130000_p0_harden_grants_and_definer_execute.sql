-- =============================================================================
-- P0: Harden client grants + SECURITY DEFINER EXECUTE surface
-- ID: P0-GRANT-001 / P0-DEFINER-001 / DB-R0
-- Source design: docs/database/remediation/P0_harden_grants_and_definer_execute.sql
-- Additive privilege-only: REVOKE / GRANT / ALTER DEFAULT PRIVILEGES
-- Does NOT: drop tables, mutate row data, touch auth.users, alter migration history
-- =============================================================================
