#!/usr/bin/env python3
"""Wait for PR CI checks to complete, then report status.

Usage:
  GITHUB_TOKEN=ghp_xxx HEAD_SHA=<sha> python3 scripts/wait_pr_phase_7_ci.py
"""
...
# PR_NUMBER and HEAD_SHA are filled in after PR is opened.
