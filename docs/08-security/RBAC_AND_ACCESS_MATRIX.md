...
## Canonical roles
super-admin · branch-manager · kitchen · cashier · rider · customer-support · host · waiter

## Display labels (not DB roles)
Owner / Founder → operate as super-admin (`branch_id = null`, global scope).

## Team Center
| Principal | /admin/ai-team |
| --- | --- |
| super-admin | ALLOW |
| other staff | DENY (unauthorized) |
| customer | DENY |

Do not invent owner/founder/admin/general-staff/delivery roles in the database for this work.
