...
| --- | --- | --- |
| Customer + Admin website | Vercel | React 19 + Vite monorepo app `apps/website` |
| REST API | Render | Express `backend/api` |
| Database + Auth | Supabase (PostgreSQL) | Migrations under `supabase/migrations` |
| Repository | One GitHub monorepo | `mianimr4n/telepizza` |

## Not in Production (FOUNDATION / CONFLICTS_WITH_REALITY if claimed live)
Kubernetes · microservices mesh · Prisma ORM · native mobile apps · event bus · analytics warehouse · autonomous AI runtime

## Monorepo map
- `apps/website` — customer site + Admin ERP
