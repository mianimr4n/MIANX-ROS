...
**Class:** ACTIVE (TEAS navigation alias)

Canonical architecture documents live at:

**[`../architecture/`](../architecture/)**

This numbered folder is the TEAS navigation slot. Content is stored under the stable classic path so existing tests and cross-links keep working.
...
(Stub redirect also at [`../architecture/TELEPIZZA-MASTER-ROADMAP.md`](../architecture/TELEPIZZA-MASTER-ROADMAP.md).)
