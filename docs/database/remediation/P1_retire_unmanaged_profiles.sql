-- =============================================================================
-- REMEDIATION DESIGN (source archive)
...
-- Promoted to: supabase/migrations/20260718130100_p1_retire_unmanaged_profiles.sql
-- (Owner proposed 20260718120100 — rejected to keep history after applied P0 20260718130000)
-- Applied on linked prod pyeowxvacgypohrbvgee: see _documentation-audit/reports/DB-R1-PROFILES-RETIREMENT-CLOSE.md
-- Keep this file as the design reference; do not edit the already-applied migration.
-- =============================================================================
-- Context:
