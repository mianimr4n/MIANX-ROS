...
| W-CHG-01 | 6/1 | What Changed | Since last review on this device / business window | Owner | Org/branch | EVT-* / derived KPIs | IMPLEMENTED_NOT_PRODUCTION_VERIFIED (foundation) | On review / refresh | Timeline / module routes | None | Partial / failure honest | No prior-login watermark; no unified store | Redacted | — | Cached aggregates | DASH-01…07 + device baseline | RC6-DASH-08 | Cross-device / event store |
| W-TL-01 | 3/6 | Live timeline | Derived ops list events | Owner, BM | Branch | EVT-* | IMPLEMENTED_NOT_PRODUCTION_VERIFIED (derived lists; not stream) | Manual / existing refresh | Entity module routes | None | Honest empty | Incomplete audit | Redacted | Textual severity | Bounded list | Admin lists | DASH-08 | Stream/poll / full audit |
