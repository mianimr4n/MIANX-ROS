...
| Owner Command Center depth | Still relevant · DASH-01…05 (repo; not Prod-verified); DASH-06+ remain |
...
| Branch Health Score | **DASH-05 in repository** (explainable; coverage-adjusted; not Prod-verified) |
