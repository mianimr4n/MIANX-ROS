...
| Owner Command Center depth | Still relevant · DASH-01…06 (repo; not Prod-verified); DASH-07+ remain |
...
| Approval Inbox | **DASH-04 merged** (selected sources; DRILL_DOWN only; not Prod-verified) |
| Branch Health Score | **DASH-05 merged** (explainable; coverage-adjusted; not Prod-verified) |
| Profitability Truth | **DASH-06 in repository** (Operational Estimate ≠ Accounting Posted; not Prod-verified) |
