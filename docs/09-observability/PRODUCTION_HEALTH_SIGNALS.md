...
## Browser-accessible signals
- API health/ready endpoints
- Executive Dashboard system health (super-admin)
- OperationalStatusBanner states for module fetches

## Private evidence (never in Production UI)
Private release artifacts under local private storage are for Founder/engineering closeout only.
