...
| /admin/ai-team | Mianx.ai Operating Team |
| /admin/branch | Branch readiness |
| /admin/orders | Orders |
| /admin/kitchen-dashboard | Kitchen board |
| /admin/kitchen | Kitchen ERP |
| /admin/delivery | Delivery |
| /admin/pos | POS |
| /admin/floor | Live floor |
| /admin/reservations | Reservations |
| /admin/waitlist | Waitlist |
| /admin/whatsapp | WhatsApp Order Center |
| /admin/menu | Menu |
...
## Authorization
`/admin/ai-team` requires `isSuperAdmin`. Unauthorized principals are denied via existing admin gate.
