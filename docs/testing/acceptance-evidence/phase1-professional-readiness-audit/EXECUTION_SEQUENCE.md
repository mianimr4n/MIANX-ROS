...
| 1 | Merge docs PR #193 (anchor sync) if still open | — | none | none |
| 2 | POLISH-01 | Audit | Website only | Admin shell smoke |
| 3 | POLISH-02 | POLISH-01 optional | Website only | Owner smoke |
...
**Do not** start Phase 2 Delivery/Settings runtime until Phase 1.1 gate passes.
