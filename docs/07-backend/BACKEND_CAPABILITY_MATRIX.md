...
| Capability | State |
| --- | --- |
| Auth + RBAC principal | LIVE |
| Orders CRUD/status | LIVE |
| Kitchen tickets | LIVE |
| Delivery assignments | LIVE |
| Reservations/waitlist | LIVE |
| Opening readiness probe | LIVE |
| Menu catalog | LIVE |
| Inventory stock ledger | FOUNDATION |
| Finance GL | FOUNDATION |
| Autonomous agent jobs API | UNAVAILABLE (not implemented) |
