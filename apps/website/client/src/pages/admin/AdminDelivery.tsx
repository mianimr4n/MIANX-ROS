  ...
  return (
    <AdminShell title="Delivery Management">
      <OperationsWorkspaceHeader
        ...
        description="Assign riders and advance supported delivery statuses. GPS, POD, COD settlement, and traffic ETA remain deferred."
        branchLabel={branchLabel}
        roleLabel={roleLabel}
        maturity="PARTIAL_LIVE"
        primaryTask="Clear waiting-for-rider and in-progress deliveries"
        liveLabel={assignmentsOp.state === "STALE" ? "Stale" : live ? "Live assignments" : "Offline"}
        actions={
          <>
            <button
              type="button"
      ...
      <OperationsDeferredNote
        summary="Deferred delivery capabilities (not in this workspace)"
        items={[
          "GPS / live map / traffic-based ETA",
          "Proof of delivery and COD settlement",
          "Rider shifts, zones, and capacity planning",
          "Failed-status mutation and click-to-call",
          "Channel/date advanced filters and export",
        ]}
      />
