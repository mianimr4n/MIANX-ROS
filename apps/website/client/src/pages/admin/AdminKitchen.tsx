...
export default function AdminKitchen() {
  ...
  return (
    <AdminShell title="Kitchen ERP">
      <OperationsWorkspaceHeader
        eyebrow="Operations"
        title="Kitchen ERP"
        description={`Ticket board and transitions for preparation. Station assignment and printers are not configured here. ${currentShiftLabel()} is display-only.`}
        branchLabel={branchLabel}
        roleLabel={roleLabel}
        maturity="PARTIAL_LIVE"
        primaryTask="Move tickets through queued → ready"
        liveLabel={ticketsOp.state === "STALE" ? "Stale" : live ? "Live tickets" : "Offline"}
        actions={
          <>
            <button
              type="button"
      ...
      <OperationsDeferredNote
        summary="Deferred kitchen capabilities"
        items={[
          "Station assignment and printer routing",
          "VIP / urgent priority labels (not in ticket API)",
          "Kitchen capacity prediction",
        ]}
      />
