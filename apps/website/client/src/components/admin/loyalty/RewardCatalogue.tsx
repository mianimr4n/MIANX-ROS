...
/** Rewards catalogue remains Planned for Phase 2 — points ledger is LIVE separately. */
  ...
  return (
    <AdminSurface aria-labelledby="reward-catalogue-heading">
      ...
      <AdminSurfaceBody>
        ...
        <AdminSectionTitle
          title="Rewards Catalog — Planned for Phase 2"
          description="Publishable rewards, eligibility rules, and burn-on-checkout remain Planned for Phase 2."
        />
        <div className="rounded-2xl border border-dashed border-[var(--admin-border)] bg-[var(--admin-soft)] px-4 py-6 text-sm text-[var(--admin-muted)]">
          ...
          <p className="mt-3 text-xs uppercase tracking-wide">Planned for Phase 2 — no sample rewards shown as live data</p>
        </div>
      </AdminSurfaceBody>
    </AdminSurface>
  );
